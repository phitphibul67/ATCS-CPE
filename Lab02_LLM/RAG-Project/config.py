...
SOURCE_FILE = os.path.join(DATA_DIR, "computer_q_a.txt")
...
# เพิ่มตั้งค่าสำหรับ LLM
# OpenRouter Settings
OPENROUTER_API_KEY = "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"

# โมเดลฟรีแนะนำบน OpenRouter (เช่น openrouter/free หรือ google/gemini-2.0-flash-lite-001:free)
